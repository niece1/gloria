 ...
 $prefix = "ale_";
    ...
    $meta_boxes[] = array(
     ...
     $meta_boxes[] = array(
        ...
        'fields' => array(
            array(
                'name' => __('Service Section Title', 'aletheme'),
                'desc' => __('Insert the title', 'aletheme'),
                'id'   => $prefix . 'titleservice',
                'type' => 'text',
            ),
            array(
                'name' => __('Service Section Description', 'aletheme'),
                'desc' => __('Insert the text', 'aletheme'),
                'id'   => $prefix . 'descriptionservice',
                'type' => 'textarea',
            ),
            array(
                'name' => __('Service 1 title', 'aletheme'),
                'desc' => __('Insert your service', 'aletheme'),
                'id'   => $prefix . 'titleservice1',
                'type' => 'text',
            ),
            array(
                'name' => __('Service 1 description', 'aletheme'),
                'desc' => __('Paste your phone', 'aletheme'),
                'id'   => $prefix . 'descriptionservice1',
                'std'  => '',
                'type' => 'textarea',
            ),
            array(
                'name' => __('Service 2 title', 'aletheme'),
                'desc' => __('Insert your service', 'aletheme'),
                'id'   => $prefix . 'titleservice2',
                'type' => 'text',
            ),
            array(
                'name' => __('Service 2 description', 'aletheme'),
                'desc' => __('Paste your phone', 'aletheme'),
                'id'   => $prefix . 'descriptionservice2',
                'std'  => '',
                'type' => 'textarea',
            ),
            array(
                'name' => __('Service 3 title', 'aletheme'),
                'desc' => __('Insert your service', 'aletheme'),
                'id'   => $prefix . 'titleservice3',
                'type' => 'text',
            ),
            array(
                'name' => __('Service 3 description', 'aletheme'),
                'desc' => __('Paste your phone', 'aletheme'),
                'id'   => $prefix . 'descriptionservice3',
                'std'  => '',
                'type' => 'textarea',
            ),
             array(
                'name' => __('Gallery Section Title', 'aletheme'),
                'desc' => __('Insert the title', 'aletheme'),
                'id'   => $prefix . 'titlegallery',
                'type' => 'text',
            ),
            array(
                'name' => __('Gallery Section Description', 'aletheme'),
                'desc' => __('Insert the text', 'aletheme'),
                'id'   => $prefix . 'descriptiongallery',
                'type' => 'textarea',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 1', 'aletheme'),
                'id'   => $prefix . 'fileupload1',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 2', 'aletheme'),
                'id'   => $prefix . 'fileupload2',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 3', 'aletheme'),
                'id'   => $prefix . 'fileupload3',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 4', 'aletheme'),
                'id'   => $prefix . 'fileupload4',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 5', 'aletheme'),
                'id'   => $prefix . 'fileupload5',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 6', 'aletheme'),
                'id'   => $prefix . 'fileupload6',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 7', 'aletheme'),
                'id'   => $prefix . 'fileupload7',
                'type' => 'file',
            ),
             array(
                'name' => __('Blog Section Title', 'aletheme'),
                'desc' => __('Insert the title', 'aletheme'),
                'id'   => $prefix . 'titleblog',
                'type' => 'text',
            ),
            array(
                'name' => __('Blog Section Description', 'aletheme'),
                'desc' => __('Insert the text', 'aletheme'),
                'id'   => $prefix . 'descriptionblog',
                'type' => 'textarea',
            ),
    ...
    $meta_boxes[] = array(
        ...
        'priority'   => 'high',
        'show_names' => true, // Show field names on the left
        'show_on'    => array( 'key' => 'page-template', 'value' => array('template-works.php'), ),
        'fields' => array(
            
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 1', 'aletheme'),
                'id'   => $prefix . 'fileupload11',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 2', 'aletheme'),
                'id'   => $prefix . 'fileupload12',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 3', 'aletheme'),
                'id'   => $prefix . 'fileupload13',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 4', 'aletheme'),
                'id'   => $prefix . 'fileupload14',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 5', 'aletheme'),
                'id'   => $prefix . 'fileupload15',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 6', 'aletheme'),
                'id'   => $prefix . 'fileupload16',
                'type' => 'file',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert file 7', 'aletheme'),
                'id'   => $prefix . 'fileupload17',
                'type' => 'file',
            ),
        )
    );
    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
            array(
                'name' => __('Title', 'aletheme'),
                'desc' => __('Insert the title 1', 'aletheme'),
                'id'   => $prefix . 'slidertitle1',
                'type' => 'textarea',
            ),
            array(
                'name' => __('Title', 'aletheme'),
                'desc' => __('Insert the title 2', 'aletheme'),
                'id'   => $prefix . 'slidertitle2',
                'type' => 'textarea',
            ),
        )
    );
    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => __('Request Section Title', 'aletheme'),
                'desc' => __('Insert the title', 'aletheme'),
                'id'   => $prefix . 'titlerequest',
                'type' => 'text',
            ),
            array(
                'name' => __('Request Section Description', 'aletheme'),
                'desc' => __('Insert the text', 'aletheme'),
                'id'   => $prefix . 'descriptionrequest',
                'type' => 'textarea',
            ),
            array(
                'name' => __('Button text', 'aletheme'),
                'desc' => __('Insert button text', 'aletheme'),
                'id'   => $prefix . 'button',
                'type' => 'text',
            ),
            array(
                'name' => __('File Upload', 'aletheme'),
                'desc' => __('Insert background image', 'aletheme'),
